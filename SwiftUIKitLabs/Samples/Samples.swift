...
let sampleGroups: Array<SampleGroup> = [
    ...
    SampleGroup(title: "Basics", samples: [
        Sample(
            controller: StretchScrollViewController(nibName: StretchScrollViewController.identifier, bundle: nil),
            className: StretchScrollViewController.identifier,
            title: "스트래치 스크롤"
        ),
        Sample(
            controller: StretchTableViewController(nibName: StretchTableViewController.identifier, bundle: nil),
            className: StretchTableViewController.identifier,
            title: "테이블뷰 스트래치 스크롤"
        ),
        Sample(
            controller: ExpandableSheetViewController(nibName: ExpandableSheetViewController.identifier, bundle: nil),
            className: ExpandableSheetViewController.identifier,
            title: "확장 바텀 시트"
        ),
        Sample(
            controller: ExpandableSheetTwoViewController(nibName: ExpandableSheetTwoViewController.identifier, bundle: nil),
            className: ExpandableSheetTwoViewController.identifier,
            title: "확장 바텀 시트2"
        ),
        Sample(
            controller: TransformableSheetViewController(),
            className: TransformableSheetViewController.identifier,
            title: "확장 바텀 시트3 - transform"
        ),
        Sample(
            controller: TableExpandableSheetViewController(nibName: TableExpandableSheetViewController.identifier, bundle: nil),
            className: TableExpandableSheetViewController.identifier,
            title: "확장 바텀 시트4 - tableView"
        ),
        Sample(
            controller: FinalExpandableSheetViewController(nibName: FinalExpandableSheetViewController.identifier, bundle: nil),
